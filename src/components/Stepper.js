...
const Stepper = () => {
  ...
  const steps = [
    {  image:'https://res.cloudinary.com/doejcrfso/image/upload/v1721009778/jobme/step-one-icon_f7sxq7.png', text: 'Create an account/Log In' },
      ...
      <div className="flex items-center justify-between relative">
        {steps.map((step, index) => (
          <React.Fragment key={index}>
           ...
           <p className="mt-2 text-xs text-center max-w-[80px] lg:max-w-[100px]">{step.text}</p>
           </div>
            </div>
